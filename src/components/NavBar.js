...
const DesktopNav = () => {
  ...
  const popoverContentBgColor = useColorModeValue("gray.700", "gray.700");
...
const NAV_ITEMS = [
  {
    label: "Github",
    href: "https://github.com/collinsuzebu/vessel-tracker",
  },
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/collinsuz",
  },
  {
    label: "Website",
